package com.kykyryzatorr.tasks.mappers.impl;
...
import com.kykyryzatorr.tasks.mappers.TaskListMapper;
import com.kykyryzatorr.tasks.mappers.TaskMapper;
    ...
    public TaskListDto toDto(TaskList taskList) {
        return new TaskListDto(
                ...
                Optional.ofNullable(taskList.getTasks())
                        .map(tasks -> taskList.getTasks().size())
                        .orElse(0),
